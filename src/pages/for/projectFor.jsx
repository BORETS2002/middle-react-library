...
import { ApexChartFor } from "../../components/aperxchartFor/aperxchatFor";
export default function ProjetctFor() {
  return (
    <>
      <div className='finranks porjects pb-0'>
        <div className='option-big-tex-wrapper d-flex justify-content-between'>
          <h2 className='big-text mb-5'>fair value </h2>
          <div className='icons'>
            <svg
              width='17'
              height='17'
