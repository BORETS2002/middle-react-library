...
export default function ProjetctOne() {
  return (
    <>
      <div className='finranks porjects'>
        <div className='option-big-tex-wrapper d-flex justify-content-between'>
          <h2 className='big-text'>Finranks SCORE</h2>
          <div className='icons'>
            <svg
              width='17'
              height='17'
        ...
        <div className='aperx'>
          <div className='one-progress-bar'>
            <h2 className='one-progress'>7.7 / 10.0</h2>
            <div
              className='progress'
              role='progressbar'
